    ...
    public static class EZ_EditorUtility
    {
        ...
        public static Texture LoadTexture(TextureData texData)
        {
            if (texData.tex == null)
            {
                ...
                {
                    if (!Directory.Exists("Assets/AssetStore/Editor Default Resources/" + EZ_EditorAssets.assetName))
                    {
                        Directory.CreateDirectory("Assets/AssetStore/Editor Default Resources/" + EZ_EditorAssets.assetName);
                    }

                    AssetDatabase.Refresh();

                    FileInfo fInfo = new FileInfo("Assets/AssetStore/" + EZ_EditorAssets.assetName + "/Editor/Texture Resources/" + texData.path);
